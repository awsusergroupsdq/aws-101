...
- [ ] *(Opcional)* `tofu` + `docker` + `aws` CLI instalados, solo si querés
      probar los pasos en tu máquina antes de usar GitHub Actions — ver
      "Opción B" en [infra/README.md](infra/README.md#cómo-usar).
